"""
Widgety VINTAGE/STEAMPUNK - te same funkcje, inny wygląd
"""
...
class ConnectionSection(QGroupBox):
    """Sekcja połączenia - vintage style"""
...
class TimeSection(QGroupBox):
    """Sekcja ustawiania czasu - vintage style"""
...
class BrightnessSection(QGroupBox):
    ...
    def init_ui(self):
        ...
        self.brightness_value.setStyleSheet(STYLE_LABEL_VALUE_ORANGE)
...
class DimmingSection(QGroupBox):
    """Sekcja automatycznego ściemniania - vintage"""
    ...
    def init_ui(self):
        ...
        self.night_brightness_value.setStyleSheet(STYLE_LABEL_VALUE_GOLD)
...
class ConsoleSection(QGroupBox):
    """Sekcja konsoli - terminal CRT style"""
